...
select xt.add_column('teprjtask','teprjtask_item_id',    'integer', 'references item(item_id) on delete set null', 'te');
select xt.add_column('teprjtask','teprjtask_prjtask_id', 'integer', '', 'te');
select xt.add_column('teprjtask','teprjtask_curr_id',    'integer', 'default basecurrid() references curr_symbol(curr_id) on delete set default', 'te');
